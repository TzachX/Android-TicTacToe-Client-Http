package com.example.user.localttt;//HttpRequest v1.3 Updated: 2016-07-28
//needed imports:
...
public class HttpRequest {
     ...
     *
     * @param method boolean - indicates whether this request should be sent in POST method
